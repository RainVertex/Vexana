              ...
              <div className="border-t border-app-border p-2">
                {newTaskBucket === bucket.id ? (
                  <form onSubmit={(e) => void handleAddTask(bucket.id, e)} className="flex gap-1">
                    ...
                    <button
                      type="submit"
                      className="rounded bg-app-primary px-2 py-1 text-xs text-app-primary-foreground"
                    >
                      {t("actions.add")}
                    </button>
                    <button
              ...
              >
                ...
                <div className="mt-2 flex gap-2">
                  <button
                    ...
                    className="rounded bg-app-primary px-3 py-1 text-xs text-app-primary-foreground hover:opacity-90 disabled:opacity-60"
                  >
                    {t("actions.add")}
                  </button>
                  <button
